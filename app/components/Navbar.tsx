        ...
        <div className="container _custom_container">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
              ...
              <li className="nav-item _header_nav_item">
                <Link className="nav-link _header_nav_link" href="/friend-requests">
                  ...
                  <div className="_notifications_drop_box">
                    ...
                    <div className="_notifications_all">
                      ...
                      <div className="_notification_box">
                        ...
                        <div className="_notification_txt">
                          <p className="_notification_para">
                            An admin changed the name of the group <span className="_notify_txt_link">Freelancer usa</span> to <span className="_notify_txt_link">Freelancer usa</span>
                          </p>
                          <div className="_nitification_time">
                            <span>42 minutes ago</span>
                          </div>
            ...
            <div className="_header_nav_profile" style={{ position: 'relative' }}>
              <div className="_header_nav_profile_image" onClick={() => setShowProfileDrop(!showProfileDrop)}>
                <img src="/images/profile.png" alt="Image" className="_nav_profile_img" />
              </div>
              <div className="_header_nav_dropdown">
                <p className="_header_nav_para" onClick={() => setShowProfileDrop(!showProfileDrop)}>Dylan Field</p>
                <button
              ...
              <div
                id="_prfoile_drop"
                className={`_nav_profile_dropdown _profile_dropdown ${showProfileDrop ? 'show' : ''}`}
                style={{ display: showProfileDrop ? 'block' : 'none', position: 'absolute', right: 0, top: '55px', zIndex: 100 }}
              >
            ...
            <div className="row">
              <div className="col-xl-12 col-lg-12 col-md-12">
                <ul className="_mobile_navigation_bottom_list">
                  ...
                  <li className="_mobile_navigation_bottom_item">
                    <Link href="/friend-requests" className="_mobile_navigation_bottom_link">
                  ...
                  <li className="_mobile_navigation_bottom_item" style={{ position: 'relative' }}>
                    <span onClick={() => setShowNotifyDrop(!showNotifyDrop)} className="_mobile_navigation_bottom_link">
                  ...
                  <div className="_header_mobile_toggle" onClick={() => setShowProfileDrop(!showProfileDrop)}>
                    <button type="button" className="_header_mobile_btn_link" value="go to mobile menu">
